...
Если какой-то шаг не заработал — что именно, какое сообщение показал сервис
...
Установка тега, проверки и съёмка кадров — самостоятельная работа. ИИ
допускается для формулировок и оформления.
